...
const Contact = () => {
    return (
       <div>
        <nav
        className="mx-auto fixed z-10 w-full pointer-events-none"
        >
      <div 
        className="wrapper w-full !py-8  flex items-center justify-between"
      >
      ...
      <section className="wrapper w-full grid lg:grid-cols-2 justify-items-center lg:justify-items-end">
        <img src={contactFrame} className="hidden lg:block max-w-[690px]" alt="contact-frame" />
      <div 
      className="pt-12 flex flex-col items-end"
      >
        ...
        <form className="space-y-8 max-w-md mt-16">
          <input className=" w-full bg-transparent p-2 focus:outline-none focus:ring-none border-b-line border border-transparent" placeholder="Fullname" />
          <input className=" w-full bg-transparent p-2 focus:outline-none focus:ring-none border-b-line border border-transparent" placeholder="Email" />
          <textarea className=" w-full bg-transparent p-2 focus:outline-none focus:ring-none border-b-line border border-transparent" placeholder="How can we help?" />
          <button className="font-bold text-xl py-3 hover:bg-hover text-p bg-services rounded-full w-full">Send</button>
        </form>
      </div>
      </section>
        ...
        <section className="hidden mt-12 lg:block w-full wrapper bg-alternative">
            <div className="flex items-center justify-between gap-4">
              <div className="max-w-4xl">
                <h3 className="text-7xl leading-normal font-gotu font-semibold">Have a project? <br/>
We would love to help.</h3>
                <p className="mt-4">
                24/7 We will answer your question
                </p>
              </div>
